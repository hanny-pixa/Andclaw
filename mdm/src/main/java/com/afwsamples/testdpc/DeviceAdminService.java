...
public class DeviceAdminService extends android.app.admin.DeviceAdminService {
  ...
  private final KioskViewModule kioskViewModule = KoinJavaComponent.get(KioskViewModule.class);

  @Override
  public void onCreate() {
    super.onCreate();
    registerPackageChangesReceiver();
    boolean isDeviceOwner = Util.isDeviceOwner(this);
    kioskViewModule.updateDeviceOwnerState(isDeviceOwner);
    Log.i("DeviceAdminService", "onCreate, isDeviceOwner: " + isDeviceOwner);
  }
