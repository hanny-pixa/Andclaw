...
public class RichTextView extends AppCompatTextView implements OnLinkClickListener {
   ...
   *       BoldLinkSpan} that broadcasts with the key "foobar"
   *   <li>&lt;annotation textAppearance="TextAppearance.FooBar"&gt; will create a {@link
   *       TextAppearanceSpan} with @style/TextAppearance.FooBar
   * </ol>
   */
  @TargetApi(28)
   ...
   * "sans-serif-medium"}
   *
   * @throws NoSuchMethodError if sdk lower than {@code VERSION_CODES.P}
   */
