...
public class TransitionHelper {
   ...
   * theme if the API level is equal or higher than {@link VERSION_CODES#U}.
   *
   ...
   * VERSION_CODES#T}. The default transition that will be applied is {@link
   * #TRANSITION_SLIDE}.
   *
   ...
   * transitionId} if the API level is equal or lower than {@link VERSION_CODES#T}.
   *
   * <p>The timing to apply the transition is going forward from the previous activity to this, or
   * going forward from this activity to the next.
   */
  ...
  /**
   * Apply the transition for going forward which is decided by {@code Animation.SudWindowAnimation}
   * theme if the API level is equal or higher than {@link VERSION_CODES#U}, and
   ...
   * {@link VERSION_CODES#U}, other {@code transitionId} can be specified if the
   * API level is equal or lower than {@link VERSION_CODES#T}, or argument {@code
   ...
   * Apply the transition for going backward which is decided by {@code
   * Animation.SudWindowAnimation} theme if the API level is equal or higher than {@link
   * VERSION_CODES#U}, and argument {@code useClientTransitionSettings} is false,
  ...
  /**
   * A wrapper method, create an {@link ActivityOptions} to transition between
   ...
   * @throws ActivityNotFoundException if there was no {@link Activity} found to run
   *     the given Intent.
   * @deprecated Deprecated to use CONFIG_TRANSITION_SHARED_X_AXIS transition, so it never have
   *     activity options input, should start the activity directly.
   */
